...
# Create IP
ipx::package_project -root_dir ./IPs/AXI4-RAM -import_files {./Sources/Utils/Calc.vhd ./Sources/AXI4-RAM/AXI4_RAM_S_AXI.vhd ./Sources/AXI4-RAM/AXI4_RAM.vhd} -vendor mohammad.ewais.ca -library ME_IPs -taxonomy {/AXI_Infrastructure /Memories_&_Storage_Elements/RAMs_&_ROMs}
